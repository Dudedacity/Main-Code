...
//lift_r.move(value);://ez-robotics.github.io/EZ-Template/
/////
...
void default_constants() {
  ...
  // Exit conditions
  chassis.pid_turn_exit_condition_set(60_ms, 1_deg, 150_ms, 5_deg, 500_ms, 500_ms);
  chassis.pid_swing_exit_condition_set(90_ms, 3_deg, 250_ms, 7_deg, 500_ms, 500_ms);
  chassis.pid_drive_exit_condition_set(90_ms, 1_in, 200_ms, 3_in, 500_ms, 500_ms);
...
///
void testing() {
  chassis.odom_xyt_set(-55.5_in, 0_in, 270_deg);

  liftPID.target_set(180);
  lift_wait();
  chassis.pid_odom_set({{-48_in, 0_in}, rev, DRIVE_SPEED}, true);
  ...
  chassis.pid_odom_set({{-48_in, -20_in, 0_deg}, rev, 70}, true);
  chassis.pid_wait();
}
...
void skills() {
  ...
  chassis.pid_turn_set(115_deg, 64);
  intake_spin(127);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(200_deg, 64);
  chassis.pid_wait();
  pros::delay(300);
  intake_spin(-32);
  pros::delay(150);
  ...
  chassis.pid_drive_set(5_in, 64, true);
  chassis.pid_wait();
  intake_spin(0);
...
void odom_pure_pursuit_example() {
  ...
  chassis.pid_odom_set({{{12_in, 10_in}, fwd, DRIVE_SPEED},
